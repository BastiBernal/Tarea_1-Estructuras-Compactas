...
set output "draws/text_size_vs_size_benchmark.pdf"

unset title

set xlabel "Tamaño del texto (MB)"
set ylabel "Espacio usado (MB)"
...
using (strstrt(strcol(2), "50MB") ? 50 : strstrt(strcol(2), "100MB") ? 100 : 200):8 \
...
\
"< tail -n +2 ../busqueda_texto_var_benchmark.csv.csv | grep 'bruta,'" \
using (strstrt(strcol(2), "50MB") ? 50 : strstrt(strcol(2), "100MB") ? 100 : 200):8 \
with points pt 9 ps 1.5 title "Fuerza Bruta"